...
class ConteoTribunalesJuzgadosGrafica extends Conteo
{
    ...
    protected function cargarDatos($args = null)
    {
        if ($this->tieneArgumento('idMunicipio', $args)) {
            ...
            return [
                ['nombre' => 'cámaras y juzgados', 'valor' => $camarasYJuzgados->total_camaras_juzgados, 'colores' => '#82436E'],
                ['nombre' => 'juzgados de paz', 'valor' => $juzgadoDePaz->total_juzgado_paz, 'colores' => '#434C8F']
            ];
