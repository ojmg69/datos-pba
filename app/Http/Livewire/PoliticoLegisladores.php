...
class PoliticoLegisladores extends Component
{
    ...
    private function cargarDatosDeTablero($args = null)
    {
        ...
        $data = [
            0 => $this->conteoPorBloquesSenadores['valores'][0] + $this->conteoPorBloquesDiputados['valores'][1],
            1 => $this->conteoPorBloquesSenadores['valores'][1] + $this->conteoPorBloquesDiputados['valores'][0],
