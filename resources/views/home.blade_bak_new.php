                                ...
                                <!-- Gallery One pop up connected with JS code below                                  
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-bubba">
                                            ...
                                            <figcaption>
                                                <center><h2 class="tm-figure-title"><span>Municipios</span></h2></center>
                                                <p class="tm-figure-description">Ingresar</p>
                                                <a href="/municipios/intendente">View more</a>
                                            </figcaption>           
                                        </figure>
                                    </div>
                                    <div class="grid-item">
                                        <figure class="effect-bubba">
                                            ...
                                            <figcaption>
                                                <center><h2 class="tm-figure-title"><span>Institucional</span></h2></center>
                                                <p class="tm-figure-description">Ingresar</p>
