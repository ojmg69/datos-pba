<div class="col-12">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">  Resultados Electorales 2017</h3>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <select wire:model="tipo_resultado" name="tipoSeleccionado" class="form-control">
                                <option value="8">Senador Nacional</option>
                                <option value="9">Diputado Nacional</option>
                                <option value="10">Senador Provincial</option>
                                <option value="11">Diputado Provincial</option>
                                <option value="12">Cargos Municipales</option>
                            </select>
                        </div>
                    </div>
                </div>
