<div class="box">
    <div class="box-header" style="display: flex; justify-content: space-between;">
        <h3 class="box-title">Establecimentos Educativos</h3>
    ...
    'nombre' => 'Gráfica por Administración',
    ...
    <div style="display: flex; justify-content: flex-end">
        <button class="btn btn-info" wire:click="verDetalles">Ver detalles</button>
         ...
         <i>*La categoría "OTROS" incluye establecimientos de educación: especial,  en contexto de encierro, intercultural bilingüe, artística, de talleres y jóvenes y adultos.</i>
    @break
    @case('detalle')
    ...
    <div class="box-body">
        ...
        'boton' => [ 'nombre' => 'Activar filtro por nivel', 'evento' => 'verEscuelasPorNivel', 'resetPage' => true ],
    ...
    <div class="box-body">
        ...
        'textoDefecto' => 'Todos los niveles'
        ],

        'boton' => [ 'nombre' => 'Activar filtro por sector', 'evento' => 'verEscuelasPorSector', 'resetPage' => true ],
        'buscador' => [ 'columna' => 'nombre', 'mensaje' => 'Buscar por nombre' ],
    ...
    <script>
        window.addEventListener('mapaListo', evento => {
            ...
            mapa.agregarReferencias(referencias, 'municipios', 'Establecimientos Educativos');
