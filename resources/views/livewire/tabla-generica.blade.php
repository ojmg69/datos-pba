<div>
    <div class="tabla__controles">
        ...
        @if($conSelector)
            @livewire('selector', [
                'nombre'        => $selectorArgs['nombre'],
                'porTabla'      => $selectorArgs['porTabla'],
                'porValores'    => $selectorArgs['porValores'],
                'filtrarPor'    => $selectorArgs['filtrarPor'],
                'textoDefecto'  => $selectorArgs['textoDefecto'],
                'valorInicial'  => $selectorArgs['valorInicial'],
            ])
        @endif
